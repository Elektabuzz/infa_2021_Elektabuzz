...
class Gun:
    ...
    def hit_first_type_bullet(self, points=1):
    ...
    def hit_second_type_bullet(self, points=3):
        """Попадание шарика в цель.
        Args:
            points - шаг изменения количества очков при попадании в цель
        """
